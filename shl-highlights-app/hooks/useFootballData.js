...
export function useFootballData(activeSport, selectedFootballTeams, options = {}) {
    ...
    // NOTE: Initial auto-scroll for the football tab is handled centrally in
    // app/index.js against the COMBINED (Allsvenskan + Svenska Cupen) list.
    // A previous auto-scroll effect lived here too, scrolling the same listRef
    // to an Allsvenskan-only targetGameIndex — it raced the combined-list effect
    // and made the landing position inconsistent when switching tabs. Removed.
